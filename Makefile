vendor/libretro-fceumm/fceumm_libretro_emscripten.bc:
	CFLAGS="-s SIDE_MODULE=1" emmake make -C vendor/libretro-fceumm
...
emscripten: build-emscripten/out/index.html vendor/libretro-fceumm/fceumm_libretro_emscripten.bc
	cp -rf vendor/libretro-fceumm/fceumm_libretro_emscripten.bc build-emscripten/out
